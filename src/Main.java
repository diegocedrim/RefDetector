...
public class Main extends RefactoringHandler {
	...
	public static void main(String[] args) {
		...
		try {
			Repository repository = gitService.cloneIfNotExists("/Users/diego/ref-detector-output/OpenConext-cruncher", "https://github.com/OpenConext/OpenConext-cruncher.git");
			detector.detectAll(repository, "master", new Main());
			//			RevWalk walk = gitService.createAllRevsWalk(repository, "master");
			//			for (RevCommit revCommit : walk) {
			//				
			//				System.out.println(revCommit.getName() + " " + revCommit.getParent(0).getName());
			//			}
		} catch (Exception e) {
			e.printStackTrace();
		}
